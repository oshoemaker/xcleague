...
HttpHelpers.prototype.forceHttp = function(req,res,next) {
  ...
  // If it is production and not www.nw-xc.com redirect
  if (req.headers['x-forwarded-proto'] === 'https') {
    console.log('Was https...  redirecting to http');
    return res.redirect(301, 'http://www.nw-xc.com' + req.path);
  }
  
  console.log('Is http... nothing to do here');
  return next();
}
